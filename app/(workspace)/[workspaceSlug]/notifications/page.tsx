        ...
        <div className="p-6 flex items-center justify-between gap-4">
          ...
          <button
            onClick={() => {
              ...
              toast.success(!notifyApproval ? "Approval alerts enabled" : "Approval alerts disabled");
            }}
        ...
        <div className="p-6 flex items-center justify-between gap-4">
          ...
          <button
            onClick={() => {
              ...
              toast.success(!notifyComments ? "Comment notifications enabled" : "Comment notifications disabled");
            }}
            className={`relative inline-flex h-6 w-11 shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none ${
        ...
        <div className="p-6 flex items-center justify-between gap-4">
          ...
          <button
            onClick={() => {
              ...
              toast.success(!notifyDownloads ? "Download alerts enabled" : "Download alerts disabled");
            }}
            className={`relative inline-flex h-6 w-11 shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none ${
        ...
        <div className="p-6 flex items-center justify-between gap-4">
          ...
          <button
            onClick={() => {
              ...
              toast.success(!weeklyDigest ? "Weekly digest enabled" : "Weekly digest disabled");
            }}
            className={`relative inline-flex h-6 w-11 shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none ${
      ...
      <div className="rounded-2xl bg-card border border-border p-6 space-y-6 shadow-sm">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          <div className="space-y-1">
            <div className="flex items-center gap-2">
              ...
              <h3 className="text-base font-bold font-heading text-card-foreground">
                Official CineSpace WhatsApp Bot
              </h3>
            </div>
            <p className="text-xs text-muted-foreground">
              Messages will be dispatched from +1 (800) 246-3772 to your registered Gulf mobile number.
            </p>
          </div>
          ...
          <div className="flex items-center gap-2">
            ...
            />
            <Button
              onClick={() => toast.success("WhatsApp number verified")}
