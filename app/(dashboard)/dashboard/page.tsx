          ...
          <div className="bg-bg2 border border-line p-6 rounded-2xl max-w-md w-full shadow-2xl">
            ...
            <form onSubmit={handleCreate} className="space-y-4">
              ...
              <div className="flex items-center justify-end gap-3 pt-4 border-t border-line">
                ...
                <button type="submit" className="btn px-5 py-2 text-sm font-bold rounded-full">
                  Create Project
                </button>
              </div>
            </form>
          ...
          >
            <div className="h-44 relative p-6 flex flex-col justify-between" style={{ background: proj.g }}>
              ...
              <div className="z-10">
                ...
                <p className="text-xs text-white/70 mt-1">{proj.client}</p>
              </div>
            </div>
            ...
            <div className="p-5 flex items-center justify-between border-t border-line bg-bg2">
              ...
              <div className="flex items-center gap-2">
                ...
                <a
                  href={`https://wa.me/?text=${encodeURIComponent(`Hi ${proj.client}, here is your review cut for ${proj.title}: ${typeof window !== 'undefined' ? window.location.origin : ''}/deliver/${proj.id}`)}`}
                  target="_blank"
                  rel="noreferrer"
