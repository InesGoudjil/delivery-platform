...
import { ArrowLeft, Upload, Play, Check, Send, Link2, MessageCircle, Lock } from "lucide-react";
  ...
  return (
    <div className="max-w-5xl mx-auto space-y-8">
      ...
      <div className="bg-bg2 border border-line rounded-2xl p-6 md:p-8 flex flex-col md:flex-row md:items-center justify-between gap-6">
        <div>
          <div className="flex items-center gap-3 mb-2">
            ...
            <span className="text-xs text-dim font-mono">ID: {params.id}</span>
          </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        {/* Video Preview & Version Selector */}
