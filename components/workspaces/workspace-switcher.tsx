      ...
      <SidebarMenuItem>
        <DropdownMenu>
          <DropdownMenuTrigger asChild>
            <SidebarMenuButton
              size="lg"
              className="data-[state=open]:bg-sidebar-accent data-[state=open]:text-sidebar-accent-foreground hover:bg-sidebar-accent/50 transition-colors rounded-xl"
            >
          ...
          <DropdownMenuContent
            className="w-(--anchor-width) min-w-56 rounded-2xl bg-popover border border-border text-popover-foreground p-2 shadow-2xl backdrop-blur-xl z-50 animate-in fade-in zoom-in-95 duration-150"
            align="start"
            side={isMobile ? "bottom" : "right"}
            sideOffset={8}
          >
            <DropdownMenuLabel className="text-xs text-muted-foreground font-mono px-2 py-1 uppercase tracking-wider">
              Workspaces
            </DropdownMenuLabel>
            ...
            {list.map((ws, index) => {
              ...
              return (
                <DropdownMenuItem
                  ...
                  className="gap-2.5 p-2 rounded-xl text-xs font-medium cursor-pointer hover:bg-accent hover:text-accent-foreground transition-colors"
                >
                  <div className="flex size-6 items-center justify-center rounded-md border border-border bg-muted font-bold text-[10px] text-primary">
                    {wsInitials}
                  </div>
            ...
            <DropdownMenuItem
              asChild
              className="gap-2.5 p-2 rounded-xl text-xs font-semibold text-primary hover:bg-primary/15 cursor-pointer transition-colors"
            >
              <Link href="/new-workspace">
                <div className="flex size-6 items-center justify-center rounded-md border border-primary/40 bg-primary/10">
