...
export default function LandingPage() {
  ...
  const [activeProject, setActiveProject] = useState<ProjectDemo>(SAMPLE_PROJECTS[0]);
  const [activeVersion, setActiveVersion] = useState("V2");
  const [toast, setToast] = useState<string | null>(null);
  const [activeFeatureTab, setActiveFeatureTab] = useState<"review" | "portfolio" | "whatsapp">("review");
  ...
  const [comments, setComments] = useState<Array<{ who: "client" | "me"; meta: string; text: string }>>([
    ...
    { who: "me", meta: "Filmmaker · 1h ago", text: "On it! Adjusted in V2. Check it out now." },
  ]);
  ...
  const handleAddComment = () => {
    ...
    setComments((prev) => [
      ...prev,
      { who: "client", meta: "Client (You) · Just now", text: commentInput.trim() },
    ]);
    setCommentInput("");
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        ...
        <div className="py-8 border-b border-white/[0.08] text-center">
          ...
          <div className="flex flex-wrap items-center justify-center gap-8 sm:gap-12 text-sm font-bold text-[#9a9a9f]">
            <span className="hover:text-[#f6f3ec] transition-colors">Lost in Tokyo</span>
            <span className="text-white/20">•</span>
            <span className="hover:text-[#f6f3ec] transition-colors">Clean Performance</span>
            <span className="text-white/20">•</span>
            <span className="hover:text-[#f6f3ec] transition-colors">Prestige Rentals</span>
            <span className="text-white/20">•</span>
            <span className="hover:text-[#f6f3ec] transition-colors">Seen Couture</span>
          </div>
        </div>
        ...
        <section id="features" className="py-20 border-b border-white/[0.08]">
          <div className="text-center max-w-2xl mx-auto mb-14">
            ...
            <p className="text-[#9a9a9f] mt-4 text-base">
              Replace messy email threads, wetransfer links, and confusion with a single branded client room.
            </p>
          </div>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
                <div className="lg:col-span-5 space-y-5">
                  ...
                  <p className="text-[#9a9a9f] text-sm sm:text-base leading-relaxed">
                    Clients pause at exact frames, leave feedback, and compare V1 vs V2. Once satisfied, they hit <b>Approve Final Cut</b>, locking the version so you can export finals with 100% confidence.
                  </p>
                  <ul className="space-y-3 text-sm text-[#9a9a9f] font-medium">
                    <li className="flex items-center gap-2.5 text-[#f6f3ec]">
                      <Check className="size-4 text-[#86b98f]" /> Timecode precise comments
                    </li>
                    <li className="flex items-center gap-2.5 text-[#f6f3ec]">
                      <Check className="size-4 text-[#86b98f]" /> Instant version history (V1, V2, Final)
                    </li>
                    <li className="flex items-center gap-2.5 text-[#f6f3ec]">
                      <Check className="size-4 text-[#86b98f]" /> Formal client sign-off locking
                    </li>
                  </ul>
                  <Button
                    onClick={() => setShowDemoModal(true)}
                    className="rounded-full bg-[#f5551d] text-[#160a03] font-semibold mt-2"
                  >
                ...
                <div className="lg:col-span-7 bg-[#0a0a0b] border border-white/10 rounded-2xl p-4 sm:p-6">
                  <div className="flex items-center justify-between border-b border-white/10 pb-3 mb-4">
                    ...
                    <span className="text-xs font-mono text-[#5e5e64]">cut.app/review/omakase-v2</span>
                  </div>
                  <div className="aspect-video bg-gradient-to-br from-[#3a1a10] to-[#7a2f18] rounded-xl flex flex-col justify-between p-4 relative overflow-hidden">
                    <div className="flex justify-between items-start">
                      <span className="px-2.5 py-1 bg-black/60 rounded text-xs font-mono">00:24.12</span>
                      <Badge variant="sage" className="flex items-center gap-1 font-semibold">
                    ...
                    <div className="flex justify-between items-end">
                      <div className="flex gap-1.5">
                        <span className="px-2.5 py-1 bg-white/10 rounded-full text-xs font-mono">V1</span>
                        <span className="px-2.5 py-1 bg-[#f5551d] text-black font-bold rounded-full text-xs font-mono">V2</span>
                        <span className="px-2.5 py-1 bg-white/10 rounded-full text-xs font-mono">Final</span>
                      </div>
                      <span className="text-xs text-[#9a9a9f]">Cloudflare 4K Stream</span>
                    </div>
                  </div>
                  <div className="mt-4 space-y-2">
                    <div className="p-3 bg-[#141416] border border-white/10 rounded-xl text-xs flex gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-[#f6f3ec]">“Can we make the intro color grade warmer?”</p>
                      </div>
                    </div>
                  </div>
                </div>
            ...
            {activeFeatureTab === "portfolio" && (
              <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
                <div className="lg:col-span-5 space-y-5">
                  ...
                  <p className="text-[#9a9a9f] text-sm sm:text-base leading-relaxed">
                    Showcase your best commercial reels, wedding highlights, and brand films on a sleek dark surface designed specifically for video playback without lag or distraction.
                  </p>
                  <ul className="space-y-3 text-sm text-[#9a9a9f] font-medium">
                    <li className="flex items-center gap-2.5 text-[#f6f3ec]">
                      <Check className="size-4 text-[#86b98f]" /> Custom domain & studio branding
                    </li>
                    <li className="flex items-center gap-2.5 text-[#f6f3ec]">
                      <Check className="size-4 text-[#86b98f]" /> Pinned showreel hero spotlight
                    </li>
                    <li className="flex items-center gap-2.5 text-[#f6f3ec]">
                      <Check className="size-4 text-[#86b98f]" /> Optimized for high-bitrate mobile playback
                    </li>
                  </ul>
                </div>
                <div className="lg:col-span-7 bg-[#0a0a0b] border border-white/10 rounded-2xl p-6 grid grid-cols-1 sm:grid-cols-2 gap-4">
                  {SAMPLE_PROJECTS.map((proj) => (
                    <Card key={proj.id} className="bg-[#141416] border-white/10 rounded-xl overflow-hidden p-3 space-y-3">
                      <div className="aspect-video rounded-lg flex items-center justify-center relative overflow-hidden" style={{ background: proj.g }}>
                      ...
                      <div>
                        <h4 className="disp text-sm font-bold text-[#f6f3ec]">{proj.title}</h4>
            ...
            {activeFeatureTab === "whatsapp" && (
              <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
                <div className="lg:col-span-5 space-y-5">
                  ...
                  <p className="text-[#9a9a9f] text-sm sm:text-base leading-relaxed">
                    Clients in the Gulf live on WhatsApp. CUT generates private links optimized for instant previewing directly inside WhatsApp or mobile Safari with zero signup required.
                  </p>
                  <ul className="space-y-3 text-sm text-[#9a9a9f] font-medium">
                    <li className="flex items-center gap-2.5 text-[#f6f3ec]">
                      <Check className="size-4 text-[#86b98f]" /> Zero client account creation required
                    </li>
                    <li className="flex items-center gap-2.5 text-[#f6f3ec]">
                      <Check className="size-4 text-[#86b98f]" /> Auto-generated mobile share links
                    </li>
                    <li className="flex items-center gap-2.5 text-[#f6f3ec]">
                      <Check className="size-4 text-[#86b98f]" /> Immediate feedback alerts on your phone
                    </li>
                  </ul>
                </div>
                <div className="lg:col-span-7 bg-[#0a0a0b] border border-white/10 rounded-2xl p-6 flex items-center justify-center">
                  <Card className="w-full max-w-sm bg-[#141416] border-white/15 rounded-2xl p-4 shadow-xl space-y-3">
                    <div className="flex items-center gap-3 border-b border-white/10 pb-3">
                      ...
                      <div>
                        <h4 className="text-xs font-bold text-[#f6f3ec]">WhatsApp Client Share</h4>
                        <p className="text-[11px] text-[#86b98f]">Online · Private Delivery</p>
                      </div>
                    </div>
                    <div className="bg-[#1c1c20] p-3 rounded-xl rounded-tl-none border border-white/10 text-xs space-y-2">
                      <p className="text-[#9a9a9f]">
                        Hey! Here is the latest V2 cut for the Omakase launch teaser:
                      </p>
                      ...
                      <span className="text-[10px] text-[#5e5e64] block text-right">10:42 AM</span>
                    </div>
                  </Card>
                </div>
              </div>
        ...
        <section id="workflow" className="py-20 border-b border-white/[0.08]">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <Card className="bg-[#141416] border-white/10 rounded-2xl p-8 space-y-4">
              <span className="disp text-4xl font-extrabold text-[#f5551d]">01</span>
              <h3 className="disp text-xl font-bold text-[#f6f3ec]">Upload Your Cut</h3>
              <p className="text-sm text-[#9a9a9f] leading-relaxed">
                Export from Premiere, DaVinci, or Final Cut and drag your MP4 or ProRes export into CUT. Automatic Cloudflare streaming setup.
              </p>
            </Card>

            <Card className="bg-[#141416] border-white/10 rounded-2xl p-8 space-y-4">
              <span className="disp text-4xl font-extrabold text-[#f5551d]">02</span>
              <h3 className="disp text-xl font-bold text-[#f6f3ec]">Share Private Link</h3>
              <p className="text-sm text-[#9a9a9f] leading-relaxed">
                Send a private, branded link via WhatsApp or email. Your client opens it on any browser without needing to register or log in.
              </p>
            </Card>

            <Card className="bg-[#141416] border-white/10 rounded-2xl p-8 space-y-4">
              <span className="disp text-4xl font-extrabold text-[#f5551d]">03</span>
              <h3 className="disp text-xl font-bold text-[#f6f3ec]">Review & Sign-Off</h3>
              <p className="text-sm text-[#9a9a9f] leading-relaxed">
        ...
        <section id="pricing" className="py-20 border-b border-white/[0.08]">
          <div className="text-center max-w-2xl mx-auto mb-10">
            ...
            <p className="text-[#9a9a9f] mt-4 text-base">
              Simple, predictable plans designed for Gulf creators and boutique studios.
            </p>
            ...
            <div className="inline-flex items-center gap-3 mt-8 p-1 rounded-full bg-[#141416] border border-white/10">
              <button
                ...
                className={`px-5 py-2 rounded-full text-xs font-bold transition-all ${
                  billing === "monthly" ? "bg-[#f5551d] text-[#160a03]" : "text-[#9a9a9f]"
                }`}
              >
                Monthly Billing
              </button>
              <button
                ...
                className={`px-5 py-2 rounded-full text-xs font-bold transition-all flex items-center gap-1.5 ${
                  billing === "annual" ? "bg-[#f5551d] text-[#160a03]" : "text-[#9a9a9f]"
                }`}
              >
                Annual Billing <span className="text-[10px] bg-black/40 px-1.5 py-0.5 rounded">SAVE 20%</span>
              </button>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-12">
            ...
            <Card className="bg-[#141416] border-white/10 rounded-2xl p-8 flex flex-col justify-between hover:border-white/20 transition-all">
              <div>
                ...
                <p className="text-xs text-[#9a9a9f] mt-1">For independent videographers</p>
                <div className="my-6">
                ...
                <ul className="space-y-3 text-xs text-[#9a9a9f]">
                  <li className="flex items-center gap-2">
                    <Check className="size-4 text-[#f5551d]" /> 5 Active client projects
                  </li>
                  <li className="flex items-center gap-2">
                    <Check className="size-4 text-[#f5551d]" /> 1080p Cloudflare CDN streaming
                  </li>
                  <li className="flex items-center gap-2">
                    <Check className="size-4 text-[#f5551d]" /> WhatsApp mobile delivery links
                  </li>
                  <li className="flex items-center gap-2">
                    <Check className="size-4 text-[#f5551d]" /> Timecoded client feedback
                  </li>
                </ul>
              </div>
              <Button
            ...
            <Card className="bg-[#141416] border-2 border-[#f5551d] rounded-2xl p-8 flex flex-col justify-between relative shadow-2xl shadow-[#f5551d]/10">
              <Badge variant="orange" className="absolute -top-3.5 left-1/2 -translate-x-1/2 px-4 py-1 text-[10px] font-extrabold uppercase tracking-widest bg-[#f5551d] text-black border-none shadow-md">
                MOST POPULAR
              </Badge>
              <div>
                <h3 className="disp text-2xl font-bold text-[#f6f3ec]">Studio</h3>
                <p className="text-xs text-[#9a9a9f] mt-1">For active boutique production studios</p>
                <div className="my-6">
                  <span className="disp text-4xl font-extrabold text-[#f6f3ec]">
                ...
                <ul className="space-y-3 text-xs text-[#9a9a9f]">
                  <li className="flex items-center gap-2 text-[#f6f3ec] font-semibold">
                    <Check className="size-4 text-[#f5551d]" /> Unlimited active client projects
                  </li>
                  <li className="flex items-center gap-2 text-[#f6f3ec] font-semibold">
                    <Check className="size-4 text-[#f5551d]" /> 4K Ultra-HD video streaming
                  </li>
                  <li className="flex items-center gap-2">
                    <Check className="size-4 text-[#f5551d]" /> Custom brand logo & colors
                  </li>
                  <li className="flex items-center gap-2">
                    <Check className="size-4 text-[#f5551d]" /> Custom studio handle/domain
                  </li>
                  <li className="flex items-center gap-2">
                    <Check className="size-4 text-[#f5551d]" /> Version locking & download protection
                  </li>
                </ul>
              </div>
              <Button
            ...
            <Card className="bg-[#141416] border-white/10 rounded-2xl p-8 flex flex-col justify-between hover:border-white/20 transition-all">
              <div>
                <h3 className="disp text-2xl font-bold text-[#f6f3ec]">Agency</h3>
                <p className="text-xs text-[#9a9a9f] mt-1">For production houses & media agencies</p>
                <div className="my-6">
                  <span className="disp text-4xl font-extrabold text-[#f6f3ec]">
                ...
                <ul className="space-y-3 text-xs text-[#9a9a9f]">
                  <li className="flex items-center gap-2">
                    <Check className="size-4 text-[#f5551d]" /> Everything in Studio plan
                  </li>
                  <li className="flex items-center gap-2">
                    <Check className="size-4 text-[#f5551d]" /> Team collaborator seats
                  </li>
                  <li className="flex items-center gap-2">
                    <Check className="size-4 text-[#f5551d]" /> High-bandwidth priority allocation
                  </li>
                  <li className="flex items-center gap-2">
                    <Check className="size-4 text-[#f5551d]" /> Custom client NDA seals
                  </li>
                </ul>
              </div>
              <Button
        ...
        <section className="py-20 text-center">
          <div className="rounded-[32px] bg-gradient-to-br from-[#ff9a4e] via-[#f5551d] to-[#7a2109] p-10 sm:p-16 relative overflow-hidden shadow-2xl">
            <div className="grain opacity-10" />
            <h2 className="disp text-3xl sm:text-5xl font-black text-[#160a03] leading-tight relative z-10">
              Ready to elevate your video delivery?
            </h2>
            <p className="text-[#160a03]/80 font-medium text-base sm:text-lg max-w-xl mx-auto mt-4 relative z-10">
              Join top filmmakers in Dubai, Abu Dhabi, and across the Gulf sending polished cuts today.
            </p>
            <div className="mt-8 relative z-10 flex flex-wrap items-center justify-center gap-4">
              <Button
                onClick={() => showToast("Free trial registration initiated!")}
                size="lg"
                className="rounded-full bg-[#160a03] text-[#f5551d] hover:bg-black font-bold px-8 py-4 text-base shadow-2xl transition-transform hover:-translate-y-0.5"
              >
        ...
        <div className="fixed inset-0 z-50 bg-black/80 backdrop-blur-md flex items-center justify-center p-4 sm:p-6 overflow-y-auto animate-in fade-in duration-200">
          <div className="bg-[#141416] border border-white/15 rounded-3xl w-full max-w-4xl max-h-[90vh] overflow-y-auto p-6 sm:p-8 space-y-6 text-[#f6f3ec] shadow-2xl relative">
            ...
            <div className="flex items-center justify-between gap-2 overflow-x-auto pb-2">
              ...
              <span className="text-xs text-[#5e5e64] shrink-0 font-mono">Simulated Client Experience</span>
            </div>
            ...
            <div className="space-y-4">
              ...
              >
                <div className="flex items-center justify-between z-10">
                  <span className="disp font-bold text-base text-[#f6f3ec]">{activeProject.title}</span>
                ...
                <div className="flex items-center justify-between z-10 text-xs font-mono">
                  <span className="bg-black/60 px-2.5 py-1 rounded-md">00:24 / {activeProject.tc}</span>
                  <span className="bg-black/60 px-2.5 py-1 rounded-md text-[#86b98f]">4K Ultra-HD</span>
                </div>
              </div>

              {/* Version History Chips */}
              <div className="flex items-center gap-2 border-b border-white/10 pb-4">
                <span className="text-xs text-[#9a9a9f] font-semibold mr-2">Versions:</span>
                {["V1", "V2", "Final"].map((v) => (
                  <button
                    key={v}
            ...
            <div className="flex flex-wrap items-center gap-3">
              <Button
                onClick={() => showToast("Downloading high-res video export...")}
                variant="outline"
              ...
              {!isApproved ? (
                ...
                <Badge variant="sage" className="px-4 py-2 font-bold uppercase tracking-wider text-xs gap-2">
                  <Check className="size-4" /> Approved & Locked
                </Badge>
              )}

              <Button
                onClick={() => showToast("Opening WhatsApp chat with filmmaker...")}
                variant="outline"
                className="rounded-full border-white/20 text-[#f6f3ec] hover:bg-white/10 text-xs gap-2"
              >
            ...
            <div className="bg-[#0a0a0b] border border-white/10 rounded-2xl p-5 space-y-4">
              <h4 className="disp text-sm font-bold text-[#f6f3ec]">Client Notes & Feedback</h4>
                  ...
                  <div key={i} className="flex gap-3 text-xs border-b border-white/5 pb-2">
                    <div
                      className={`w-7 h-7 rounded-full flex items-center justify-center font-bold text-[11px] shrink-0 ${
                        c.who === "me" ? "bg-[#f5551d] text-black" : "bg-white/10 text-[#f6f3ec]"
                      }`}
                    >
                      {c.who === "me" ? "P" : "C"}
                    </div>
                    <div>
                      <div className="text-[11px] text-[#5e5e64] mb-0.5">{c.meta}</div>
